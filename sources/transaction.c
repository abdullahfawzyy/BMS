...
void withdraw(){
    char userid[20];
    double amount;
    int index = -1; // Standard "not found" flag
    ...
    //care for the daily limit
    // Note: Ideally, check if date changed to reset limit, but for now we enforce the counter
